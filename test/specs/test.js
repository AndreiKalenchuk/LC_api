import {userRegister} from "../helpersApi/apiHelpers";
...
describe('TC-U001', () => {
    it('register new user api', async () => {
        await userRegister(user.newUser);
    });
    ...
    it('new user logIn first step', () => {
        ...
        browser.waitUntil(() =>
            LoginPage.dropDownCountry.isDisplayed(),
    ...
    it('new user login step 2', () => {
        ...
        LoginPage.inputPhone.doubleClick();
        LoginPage.inputPhone.keys('Delete');
        LoginPage.inputPhone.setValue(user.newUser.phone)
        LoginPage.btnSubmit.click();
        browser.waitUntil(() => ProfilePage.referalLink.isExisting,
