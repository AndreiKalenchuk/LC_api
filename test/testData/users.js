...
const englishLevel = ['Zero', 'Beginner', 'Elementary', 'Pre-Intermediate', 'Intermediate',
    'Upper intermediate', 'Advanced', 'Proficient'];
const countryName = ['United States', 'United Kingdom', 'Ukraine',
    'Slovenia', 'Netherlands', 'Belarus'];
